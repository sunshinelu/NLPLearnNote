...
get_ipython().magic(u"time df_data['X'] = df_data['words'].apply(X_padding)")
get_ipython().magic(u"time df_data['y'] = df_data['tags'].apply(y_padding)")
...
with open('data/data.pkl', 'wb') as outp:
    get_ipython().magic(u'time pickle.dump(X, outp)')
    get_ipython().magic(u'time pickle.dump(y, outp)')
...
with open('data/data.pkl', 'rb') as inp:
    get_ipython().magic(u'time X = pickle.load(inp)')
    get_ipython().magic(u'time y = pickle.load(inp)')
...
get_ipython().magic(u'time saver.restore(sess, best_model_path)')
